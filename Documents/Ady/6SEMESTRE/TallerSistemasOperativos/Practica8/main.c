...
void inicializaSuspendidos(int suspendidos[])
{
    int i;
...
void insertaSuspendido(int suspendidos[],int numPrograma)
{
    int i=0;
    ...
    {
        if(suspendidos[i] == '\0')
            suspendidos[i] = numPrograma;
    }
}

void Proceso(COLAPROCESO *NUEVOS,int cantidadProcesos,COLAPROCESO *LISTOS,COLAPROCESO *CPN,COLAPROCESOTERMINADO *CPT,COLAPROCESO *SUSPENDIDOS,int quantum)
{
    int bndBloqueado=0;
    int bndSuspendido=0;
    int bndEspacio=0;
    ...
    int bndError=0;
    int procesoEspera=0;
    int contProcesoSuspendidos=0;
    int senal=0;
    int numMarco=0;
    int ax1=0;
    int numPag=0;
    int numeroProg=0;
    int numProSuspMostrar=0;
    int tamanoSuspMostrar=0;
    int memoria=0;
    int posicion=0;
    int listaSuspendidos[15];
    ...
    NodoProceso *auxSuspendidos;
    NodoProceso *aux;
    NodoProceso *auxiliarI;
    NodoProceso *auxSuspI;
    NodoProceso *auxCPN;
    ...
    while((aux != NULL) || (contProcesoSuspendidos > 0))
    {
        if(aux != NULL)
        {
            ...
            if(contProcesoSuspendidos > 0)
            {
                gotoxy(80,5);printf("Susp: %d",contProcesoSuspendidos); //Cantidad de Suspendidps
                gotoxy(93,3);printf("Proceso Susp. a Entrar: %d",numProSuspMostrar);
                gotoxy(93,5);printf("Tam. Proc.Susp. Entrar: %d",tamanoSuspMostrar);
            }
            ...
            while(auxListos != NULL)
            {
                ...
                else
                {
                    ...
                    for(i=0; i<15; i++)
                    {
                        numeroProg=auxListos->Proceso.numPrograma;
                        if(numeroProg == listaSuspendidos[i])
                            bndError=1;
                    }

                    if((auxListos->Proceso.status == 0) && (bndError == 0) && (senal == 0))
                    {
                        gotoxy(37,13+auxgoto); printf("Num. Programa: %d",auxListos->Proceso.numPrograma);
                        gotoxy(46,15+auxgoto);printf("TME: %d",auxListos->Proceso.TME);
                        gotoxy(34,17+auxgoto);printf("Tiempo Restante: %d",auxListos->Proceso.TiempoRest);
                    ...
                    {
                        if((auxListos->Proceso.status == 1) && (bndError == 0) && (senal == 0))
                        {
                            gotoxy(57,13+aux_goto);printf("Num. Programa: %d",auxListos->Proceso.numPrograma);
                            gotoxy(67,15+aux_goto);printf("TTB: %d",auxListos->Proceso.contTiempoEspera);
                            aux_goto+=6;
            ...
            {
                proceso.tRespuesta=relojGlobal;
                proceso.bndNuevo=1;
            }
            gotoxy(82,10);printf("Proceso en Ejecucion");
                                ...
                                if((bndEspacio == 1) && (nuevos <= 0))
                                {
                                    ...
                                    while(auxiliarI != NULL)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            for(i=0; i<15; i++)
                                            {
                                                numeroProg=auxiliarI->Proceso.numPrograma;
                                                if(numeroProg == listaSuspendidos[i])
                                                    bndError=1;
                                            }
                                            if((auxiliarI->Proceso.status == 0) && (bndError == 0) && (senal == 0))
                                            {
                                                gotoxy(37,13+axxgoto); printf("Num. Programa: %d",auxiliarI->Proceso.numPrograma);
                                                gotoxy(46,15+axxgoto);printf("TME: %d",auxiliarI->Proceso.TME);
                                                gotoxy(34,17+axxgoto);printf("Tiempo Restante: %d",auxiliarI->Proceso.TiempoRest);
                            ...
                            else
                            {
                                if(caracter == 'T')
                                {
                                    while(carac != 'C')
                                    {
                                        ...
                                        while(auxiliarI != NULL)
                                        {
                                            ...
                                            if(bndError == 0)
                                            {
                                                ...
                                                gotoxy(52,10+gotobcp);printf("%d",auxiliarI->Proceso.tRespuesta);
                                    ...
                                    while(auxiliarI != NULL)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if((auxiliarI->Proceso.status == 1) && (bndError == 0) && (senal == 0))
                                            {
                                                auxiliarI->Proceso.contTiempoEspera++;
                                                gotoxy(57,13+axgoto);printf("Num. Programa: %d",auxiliarI->Proceso.numPrograma);
                                                gotoxy(67,15+axgoto);printf("TTB: %d",auxiliarI->Proceso.contTiempoEspera);
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            /**Mandar procesos a Cola de Suspendidos**/
                                            bndBloqueado=0;
                                            auxSuspI=aux->sig;
                                            while((auxSuspI != NULL) && (bndBloqueado == 0))
                                            {
                                                if(contProcesoSuspendidos == 0)
                                                {
                                                    if(auxSuspI->Proceso.status == 1)
                                                    {
                                                        bndBloqueado=1;
                                                    }
                                                }
                                                ...
                                                {
                                                    bndError=0;
                                                    for(ax1=0; ax1<15; ax1++)
                                                    {
                                                        numeroProg=auxSuspI->Proceso.numPrograma;
                                                        if(numeroProg == listaSuspendidos[i])
                                                            bndError=1;
                                                    }
                                                    if((auxSuspI->Proceso.status == 1) && (bndError == 0))
                                                    {
                                                        bndBloqueado=1;
                                                        senal=1;
                                                    }
                                                }
                                                auxSuspI=auxSuspI->sig;
                                            }
                                            ...
                                            if(bndBloqueado == 1)
                                            {
                                                bndSuspendido = 0;
                                                auxSuspI=aux->sig;
                                                while((auxSuspI != NULL) && (bndSuspendido == 0))
                                                {
                                                    /**Toma el primer proceso bloqueado**/
                                                    if(contProcesoSuspendidos == 0)
                                                    {
                                                        if(auxSuspI->Proceso.status == 1)
                                                        {
                                                            procesoSuspendido = auxSuspI->Proceso;
                                                            numeroProg =procesoSuspendido.numPrograma;
                                                            insertar(SUSPENDIDOS,procesoSuspendido);
                                                            contProcesoSuspendidos++;
                                                            listaSuspendidos[posListaLibre] = numeroProg;
                                                            posListaLibre++;

                                                            for(i=0; i<procesoSuspendido.cantPaginas; i++)
                                                            {
                                                                posicion = retornaPosliberaMarco(Marcos,procesoSuspendido.paginas[i].pagina,procesoSuspendido.numPrograma);
                                                            ...
                                                            muestraMemoria(Marcos);
                                                            bndSuspendido = 1;
                                                            gotoxy(80,5);printf("Susp: %d",contProcesoSuspendidos); //Cantidad de Suspendidos
                                                            //Si hay espacio en memoria
                                                            if(procesoEspera > 0)
                                                            {
                                                                if(auxSuspendidos != NULL)
                                                                {
                                                                    cantMarcosDisp=marcosDisponibles(Marcos);
                                                                    memoria=auxSuspendidos->Proceso.memProceso;
                                                                    bndEspacio=0;
                                                                    if((memoria) <= (cantMarcosDisp * 4))
                                                                    {
                                                                        bndEspacio=1;
                                                                        numPag = calculaPaginas(auxSuspendidos->Proceso.memProceso);
                                                                        for(i=0; i< numPag; i++)
                                                                        {
                                                                            numMarco=recuperaPagDisp(Marcos);
                                                                            auxSuspendidos->Proceso.paginas[i].pagina=i;
                                                                            auxSuspendidos->Proceso.paginas[i].marco=numMarco;
                                                                            Marcos[numMarco].marcoIdProceso=auxSuspendidos->Proceso.numPrograma;
                                                                            Marcos[numMarco].noMarco=numMarco;
                                                                            Marcos[numMarco].numPagina=i;
                                                                            if(memoria >= 4)
                                                                            {
                                                                                memoria -= 4;
                                                                                Marcos[numMarco].tamPagina=4;
                                                                                auxSuspendidos->Proceso.paginas[i].capPagina=4;
                                                                            }
                                                                            else
                                                                            {
                                                                                Marcos[numMarco].tamPagina=memoria;
                                                                                auxSuspendidos->Proceso.paginas[i].capPagina=memoria;
                                                                                memoria=0;
                                                                            }
                                                                            Marcos[numMarco].bndDisp=0;
                                                                            auxSuspendidos->Proceso.cantPaginas++;
                                                                        }
                                                                    }
                                                                    else
                                                                    {
                                                                         /**Toma datos del proceso por entrar**/
                                                                        numProSuspMostrar=auxSuspendidos->Proceso.numPrograma;
                                                                        tamanoSuspMostrar=auxSuspendidos->Proceso.memProceso;
                                                                    }
                                                                }

                                                                if((bndEspacio == 1) && (auxSuspendidos != NULL))
                                                                {
                                                                    insertar(LISTOS,auxSuspendidos->Proceso);

                                                                    numeroProg = auxSuspendidos->Proceso.numPrograma;

                                                                    for(i=0; i < 15; i++)
                                                                    {
                                                                        if(listaSuspendidos[i] == numeroProg)
                                                                                listaSuspendidos[i] = '\0';
                                                                    }
                                                                    auxSuspendidos->Proceso.bndTerminado=1;
                                                                    auxSuspendidos=auxSuspendidos->sig;
                                                                    contMemoria++;
                                                                    contProcesoSuspendidos--;
                                                                    procesoEspera--;
                                                ...
                                                gotoxy(78,27);printf("...Proceso de Bloqueado a Suspendido...");
                                                delay(200);
                                                gotoxy(77,27);printf("                                        ");
                                                gotoxy(57,13);   printf("                ");
                                                gotoxy(67,15);   printf("                ");
                                                ...
                                                while(auxiliarI != NULL)
                                                {
                                                    if(contProcesoSuspendidos == 0)
                                                    {
                                                        ...
                                                        {
                                                            auxiliarI->Proceso.contTiempoEspera++;
                                                            gotoxy(57,13+axgoto);printf("Num. Programa: %d",auxSuspI->Proceso.numPrograma);
                                                            gotoxy(67,15+axgoto);printf("TTB: %d",auxSuspI->Proceso.contTiempoEspera);
                                                            axgoto+=6;
                                                            if(auxiliarI->Proceso.contTiempoEspera >= auxSuspI->Proceso.tiempInt)
                                                            {
                                                                auxiliarI->Proceso.status=0;
                                                                auxiliarI->Proceso.contTiempoEspera=0;
                                                                auxiliarI->Proceso.TiempoRest=auxiliarI->Proceso.TME-auxiliarI->Proceso.tejecucion;
                                        ...
                                        else
                                        {
                                            if(caracter == 'R')
                                            {
                                                if(contProcesoSuspendidos > 0)
                                                {
                                                    /**Recupera proceso suspendido**/
                                                    if(bndInicio == 0)
                                                    {
                                                        auxSuspendidos = SUSPENDIDOS->frente->sig; //Primer proceso
                                                        bndInicio = 1;
                                                    }
                                                    if(auxSuspendidos != NULL)
                                                    {
                                                    ...
                                                    if((bndEspacio == 1) && (auxSuspendidos != NULL))
                                                    {
                                                        ...
                                                        auxSuspendidos=auxSuspendidos->sig;
                                                        gotoxy(80,27);printf("...Proceso Liberado...");
                                                        bndEspacio=0;
                                                        contMemoria++;
                                                        contProcesoSuspendidos--;
                                                        //gotoxy(3,3);printf("Nuevos: %d",nuevos); //Cantidad de Listos
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if((bndEspacio == 0) && (auxSuspendidos != NULL))
                                                            procesoEspera++;
                                                        gotoxy(82,30);printf("...En espera de espacio...");
                                                        delay(200);
                                                        gotoxy(80,30);printf("                            ");
                                                    }
                                                }
            ...
            for(i=0; i<15; i++)
            {
                if(aux != NULL)
                {
                    if(aux->Proceso.numPrograma == listaSuspendidos[i])
                        bndError=1;
                }
                else
                    bndNulo=1;
...
int main()
{
    ...
    Proceso(&NUEVOS,cantidadProcesos,&LISTOS,&CPN,&CPT,&SUSPENDIDOS,quantum);
    getch();
    return 0;
}
