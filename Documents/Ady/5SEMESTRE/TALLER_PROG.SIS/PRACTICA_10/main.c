...
int main()
{
    ...
    if(fd != NULL)
    {
        ...
        if(bandTemporal == 1)
        {
            ...
            j=0;
            fseek(fdAuxReg,0,0);
            while(fgets(cadenaTemporal,30,fdAuxReg))
            {
                contAux1++;
                for(i=0; i<5; i++)
                    valorTemp[i]='\0';
                ...
                if(difLongitud >= longAuxiliar)
                {
                    ...
                    if((contAux == contAux1) || (bandDirectivaEspacio == 1))
                    {
                        REGISTROS1.longS1 += 3;
                ...
                else
                {
                    ...
                    if(Aux < 0)
                    {
                        ...
                        for(k=0; k<(Aux*2); k++)
                        {
                            cadReg[k]=cadAuxRegistro[k];
                        }
                        for(m=k-1; m<strlen(cadAuxRegistro); m++)
                        {
                            cadReg[m]=cadAuxRegistro[k-1];
                            k++;
                        }
                        ...
                        strcat(REGISTROS1.RegS1,REGISTROS1.longFinal);
                        strcat(REGISTROS1.RegS1,REGISTROS1.dirS1);
                        strcat(REGISTROS1.RegS1,cadReg);
                        strcpy(cadChecksum,REGISTROS1.longFinal);
                        strcat(cadChecksum,REGISTROS1.dirS1);
                        strcat(cadChecksum,cadReg);
                        cont=1;
                        j=0;
                        for(i=0; i<=strlen(cadChecksum); i++)
                        {
                        ...
                        valDireccion=numeroAux+(strlen(cadReg)/2);
                        itoa(valDireccion,REGISTROS1.dirS1,16);
                        longTemp=strlen(cadReg1)/2;
                        REGISTROS1.longS1 += longTemp;
                        strcat(cadAuxRegistro,cadReg1);
                    }
                }
