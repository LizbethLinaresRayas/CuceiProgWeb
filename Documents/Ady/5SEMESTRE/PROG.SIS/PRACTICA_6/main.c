...
COD_MAQ RecuperaCodigoMaquina(FILE * fdTabOp,char codop[12],char operando[10])
{
    ...
    if(((COD_MAQUINA.DIR == 1) && ((bndImm == 0) && (bndInh == 0))) && (COD_MAQUINA.EXT == 1))
    {
...
ValXB RecuperaXB(char sentencia[5])
{
    FILE *fdXb;
    ValXB XB;
    int i=0;
